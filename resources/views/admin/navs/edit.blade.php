@extends('layouts.admin')
    @section('content')
        ...
        <div class="result_wrap">
            ...
            <form action="{{url('admin/navs/'.$field[0]['nav_id'])}}" method="post">
                ...
                <table class="add_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="nav_name" value="{{$field[0]['nav_name']}}">
                            <input type="text" name="nav_alias" class="sm" value="{{$field[0]['nav_alias']}}">
                    ...
                    <tr>
                        <th>URL：</th>
                        <td>
                            <input type="text" class="lg" name="nav_url" value="{{$field[0]['nav_url']}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="nav_order" value="{{$field[0]['nav_order']}}">
