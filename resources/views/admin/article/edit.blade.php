...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <form action="{{url('admin/article/'.$field[0]['art_id'])}}" method="post">
            {{csrf_field()}}
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="cate_id">
                            ...
                            @foreach($data as $v)
                                <option @if($v['cate_id']==$field[0]['cate_id'])selected="selected" @endif value="{{$v['cate_id']}}">{{$v['_cate_name']}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
              ...
              <th>文章标题：</th>
                    <td>
                        <input type="text" class="lg" name="art_title" value="{{$field[0]['art_title']}}">
                ...
                <tr>
                    <th>编辑：</th>
                    <td>
                        <input type="text" class="sm" name="art_editor" value="{{$field[0]['art_editor']}}">
                ...
                <tr>
                    <th>缩略图：</th>
                    <td>
                        <input type="text" size="50" name="art_thumb" value="{{$field[0]['art_thumb']}}">
...
//                                    alert(data);
                ...
                <tr>
                    <th></th>
                    <td>
                        <img id="art_thumb_img" style="max-width: 350px;max-height: 100px" src="/blog/{{$field[0]['art_thumb']}}">
                ...
                <tr>
                    <th>关键词：</th>
                    <td>
                        <input type="text" class="lg" name="art_tag" value="{{$field[0]['art_tag']}}">
                    </td>
                </tr>
                <tr>
                    <th>描述：</th>
                    <td>
                        <textarea name="art_description" >{{$field[0]['art_description']}}</textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="art_content" type="text/plain" style="width:860px;height:500px;">{!! $field[0]['art_content'] !!}</script>
                        <script type="text/javascript">
